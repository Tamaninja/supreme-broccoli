...
where T : Drawable3d
        {
            return drawable.TransformTo(nameof(drawable.Position), drawable.Position + offset, duration, easing);
        }
...
where T : Drawable3d
        {
            return (drawable.TransformTo(nameof(drawable.Position), new Vector3(drawable.Position.X, drawable.Position.Y, newZ), duration, easing));
        }
...
where T : Drawable3d
    ...
    where T : Drawable3d
        {
            return (drawable.TransformTo(nameof(drawable.Position), newPosition, duration, easing));
        }
...
where T : Drawable3d
        {
            ...
            return (drawable.TransformTo(nameof(drawable.Rotation), newRotation, duration, easing));
        }
